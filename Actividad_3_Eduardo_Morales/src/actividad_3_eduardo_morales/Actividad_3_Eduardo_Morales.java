 ...
 */
package actividad_3_eduardo_morales;
import java.util.Scanner;
/**
 *
 * @author Best Buy Uptown
 */
public class Actividad_3_Eduardo_Morales {
   ...
   Scanner entrada = new Scanner(System.in);
        System.out.println("Bienvenido, escoge un numero de esta lista:");
        System.out.println("");
        System.out.println("Suma del 0 al 10.-------------------------------[1]");
        System.out.println("Factorial del 1 al 10.--------------------------[2]");
        System.out.println("Factorial al gusto.-----------------------------[3]");
        System.out.println("Media del 0 hasta el numero elegido.------------[4]");
